...
- (NSArray<UIViewController *> *)createViewControllers {
	...
	mainViewController.tabBarItem = [[UITabBarItem alloc] initWithTitle:NSLocalizedString(@"searchButton", "") image:[UIImage systemImageNamed:@"magnifyingglass"] selectedImage:[UIImage imageNamed:@"search_selected"]];
	UINavigationController *mainNavigationController = [[UINavigationController alloc] initWithRootViewController:mainViewController];
	[viewControllers addObject:mainNavigationController];

	MapViewController *mapViewController = [[MapViewController alloc] init];
	mapViewController.tabBarItem = [[UITabBarItem alloc] initWithTitle:NSLocalizedString(@"mapButton", "") image:[UIImage systemImageNamed:@"map"] selectedImage:[UIImage imageNamed:@"map_selected"]];
	...
	ticketsViewController.tabBarItem = [[UITabBarItem alloc] initWithTitle:NSLocalizedString(@"favoritesButton", "") image:[UIImage systemImageNamed:@"star"] selectedImage:[UIImage imageNamed:@"star_fill"]];
